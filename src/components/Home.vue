...
<script>
	export default {
		...
		created() {
			const reqOne = this.axios.get("http://www.omdbapi.com/?i=tt0111161&apikey=d47f1e73");
			const reqTwo = this.axios.get("http://www.omdbapi.com/?i=tt0120737&apikey=d47f1e73");
			const reqThree = this.axios.get("http://www.omdbapi.com/?i=tt0468569&apikey=d47f1e73");
